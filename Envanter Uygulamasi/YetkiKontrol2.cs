...
{
    public partial class YetkiKontrol2 : Form
    {
        OleDbConnection baglanti;
        OleDbCommand komut;
        OleDbDataAdapter da1;

        public YetkiKontrol2()
        {
            InitializeComponent();
        ...
        private void YetkiKontrol2_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (usernameandpassword)
            {
                if (adminyetki)
                {
                    VeriSil form30 = new VeriSil();
                    form30.Show();
                    this.Close();
                }
                else
                {
                    MessageBox.Show("Bu Sayfaya Erişim İzniniz Yok!", "HATA!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            else
            {
